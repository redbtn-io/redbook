// Server-side sanitization for the legacy lead -> email automation path.
//
// Carried over verbatim from the original `functions/` service so the public
// POST /send contract (and its hardening) survives the move to Next.js.
//
