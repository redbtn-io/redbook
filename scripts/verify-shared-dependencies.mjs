...
/**
 * Verifies the app's shared dependency contract without install-time side
 * effects: the @redbtn scope must resolve to the private registry, and each
 * pinned shared package must be an exact version resolved from that registry
 * with a real publication integrity hash. This is what stops a shared package
 * silently drifting or being satisfied from a public mirror.
 */
